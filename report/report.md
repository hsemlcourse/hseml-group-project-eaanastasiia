...
**Практическая ценность:** Такие модели используются букмекерами и аналитиками для оценки вероятностей исходов. Прогнозирование футбольных матчей — нетривиальная задача из-за высокой случайности игры.
...
Understat выбран как единственный бесплатный источник исторических xG-данных для РПЛ с 2017 года. xG (expected goals) — ключевая метрика современного футбольного анализа, которая лучше отражает реальный уровень команды, чем просто голы.
...
- **Выбросы:** clip по 5σ (превентивно, реальных выбросов не обнаружено)
